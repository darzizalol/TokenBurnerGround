...
## 1. Standard library: `is_perfect_power` — the general closure of `is_perfect_square`/`is_perfect_cube` [claimed 2026-08-18T19:48:34Z]
...
## 2. Language: raw string literals `r"..."`/`r'...'` — the escape/interpolation-free sibling to ordinary strings
...
## 3. Standard library: `is_undulating` — digit-alternation classification
...
## 4. Language: range literal `a..b` — sugar over the existing `range()` builtin
...
## 5. Standard library: `is_kaprekar` — numbers whose square splits back into themselves
