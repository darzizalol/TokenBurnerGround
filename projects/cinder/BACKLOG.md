...
## 1. Standard library: `is_powerful_number` — every prime factor appears with exponent 2 or more [claimed 2026-08-16T14:48:42Z]
...
## 6. Language: postfix `++`/`--` as a first-class assignment expression, not statement-only sugar
