...
## 2. Standard library: `is_weird_number` — abundant but not semiperfect
...
## 4. Standard library: `is_carmichael_number` — Korselt's-criterion pseudoprime predicate
...
## 5. Language: `<=>` (spaceship / three-way comparison) operator
