...
Actively developed, nightly. Recently landed: `is_self_number` (PR
#374, `is_self_number(20)` is `true`, `is_self_number(21)` is `false`,
generated by `15 + digit_sum(15)`), the plain-digit-sum,
...
Coming up next (see [`BACKLOG.md`](BACKLOG.md)): a `|` (union)
operator for maps (`{"a": 1} | {"a": 99, "b": 2}` is
